    ...
    const stack = [
        {
            id: "analytics",
            icon: "🧠",
            title: { es: "Estrategia y Analítica", en: "Strategy & Analytics" },
            desc: { es: "Defino objetivos, interpreto métricas y traduzco datos en decisiones.", en: "Define objectives, interpret metrics, and turn data into decisions." },
        ...
        },
        {
            ...
            desc: { es: "Optimizo contenido para que sea visible, útil y rentable.", en: "Optimize content to be visible, useful, and profitable." },
            link: "#project-seo",
        },
        {
            id: "content",
            ...
            desc: { es: "Diseño estrategias de contenido que conectan y convierten.", en: "Design content strategies that connect and convert." },
            link: "#project-content",
        },
        {
            id: "creation",
            icon: "🎥",
            title: { es: "Creación Multiformato", en: "Multiformat Creation" },
            desc: { es: "Produzco y edito videos, piezas gráficas y storytelling visual.", en: "Produce and edit videos, graphics, and visual storytelling." },
            link: "#project-creation",
        },
        {
            id: "growth",
            icon: "🚀",
            title: { es: "Distribución y Growth", en: "Distribution & Growth" },
                ...
                {stack.map((layer) => (
                    <div key={layer.id} className="bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden">
                        ...
                        >
                            ...
                            <span className="text-gray-400 text-2xl">{openLayer === layer.id ? '−' : '+'}</span>
                        </button>
